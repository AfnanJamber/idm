...
::============================================================================
::
::   IDM Activator By AfnanJamber
::
::   Homepages: https://github.com/AfnanJamber/idm
::              https://Afnanjamber.blogspot.com
::              https://jambertechh.blogspot.com
::       Email: jambertech@gmail.com
::
::============================================================================
...
echo:
echo:
echo:                Proudly Sponsored By AH Mobile And Refrigeraion
echo:            ___________________________________________________ 
echo:                                                               
echo:               [1] Activate IDM                                
echo:               [2] Reset Trial Period
...
if %_erl%==5 exit /b
if %_erl%==5 start https://github.com/AfnanJamber/idm & start https://jambertech.blogspot.com & start https://wealthywagon.site & goto MainMenu
...
if defined Unattended (
timeout /t 3
start https://github.com/AfnanJamber/idm & start https://jambertech.blogspot.com & start https://wealthywagon.site & goto MainMenu exit /b
)

call :_color %_Yellow% "Press any key to return..."
pause >nul
start https://github.com/AfnanJamber/idm & start https://jambertech.blogspot.com & start https://wealthywagon.site & goto MainMenu
...
If not defined name set name=%FNAME%
...
set "reg=HKCU\SOFTWARE\DownloadManager /v Email /t REG_SZ /d "%FNAME%"" & call :_rcont
