...
echo:
echo:
echo Help - JamberTech@gmail.com
echo:
echo:
ping 127.0.0.1 -n 10
)
...
cls
color 07
title  IDM Activator By AfnanJamber
...
%eline%
echo You are running outdated version
echo ________________________________________________
echo:
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://github.com/AfnanJamber/idm & start JamberTech.blogspot.com & exit /b)
)
)
...
echo:
echo Contact Us At Jambertech.blogspot.com For help
goto done2
)
...
echo:
echo Contact Us For Help at JamberTech.blogspot.com
goto done2
)
...
echo:                                                               
echo:               [1] Stop Trail To Decrease
echo:               [2] Activat IDM
echo:               [3] Trail priod Change Back To 30 days
...
if %_erl%==6 exit /b
if %_erl%==5 start https://github.com/AfnanJamber/idm & start https://jambertech.blogspot.com & https://wealthywagon.site & goto MainMenu
...
echo:
echo Help: JamberTech.Blogspot.com
goto :done
)
